...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-11 col-xl-2">
                        <h1 class="mb-0 site-logo"><a href="index.html" class="mb-0">BMW<span
    ...
    <div class="container-card">
        <div class="item">
            <div class="image">
                <img src="<?php echo $row["image4"]; ?>" alt="Car 1">
            </div>
        </div>
        <div class="item">
            <div class="details">
        ...
        <div class="item">
            <div class="details">
                ...
                <h4 class="text-center"><b>Price<br></b><?php echo $row['price']; ?>
                    ...
                    <a href="./dynamic/booking.php?carid=<?php echo $row['id']; ?>&&car=<?php echo $row['model'] ?>"
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>If you are unable to find the information you are looking for on the BMW Group website,
