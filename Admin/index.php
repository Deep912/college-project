        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link count-indicator" id="countDropdown" href="./dynamic/signout.php"
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Cars and Users</li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="./dynamic/allcars.php">view cars</a>
                                </li>
                            </ul>
                            <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu ">
                                <li class="nav-item"> <a class="nav-link" href="./dynamic/allusers.php">All Users</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    ...
                                    <div>
                                        <div class="btn-wrapper">
                                            <a href="./dynamic/allcars.php"
                                                class="btn btn-otline-dark align-items-center"><i
                                                    class=" mdi mdi-account-card-details "></i> Cars</a>
                                            <a href="./dynamic/allusers.php"
                                                class="btn btn-otline-dark align-items-center"><i
                                                    class="mdi mdi-account-settings"></i> Users</a>
                                            <a href="#" class="btn btn-otline-dark"><i class="icon-printer"></i>
                                                Print</a>
                                            <a href="./dynamic/signout.php" class="btn btn-primary text-white me-0"><i
                                                    class="mdi mdi-account-remove"></i> Sign Out</a>
                                        </div>
                                    </div>
                                </div>
...
<div class="container">
    <header class="title">Welcome back</header>
