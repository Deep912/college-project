...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-11 col-xl-2">
                        <h1 class="mb-0 site-logo"><a href="index.php" class="mb-0">BMW<span
                    ...
                    <div class="col-12 col-md-10 d-none d-xl-block">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            ...
                            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                                ...
                                <?php } else { ?>
                                <li><a href="login.html" class="nav-link">Join us</a></li>
                                <?php } ?>
                            </ul>
                        </nav>
                    </div>
        ...
        <section class="site-section" id="work-section">
            <div class="container">
                <h2 class="site-section-heading text-center">Upcoming</h2>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <a href="images/img_1.jpg" class="media-1" data-fancybox="gallery">
                            <img src="images/required/BMW-MY24-X5-HP-Secondary-FMA-Desktop.avif" alt="Image"
                                class="img-fluid">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <a href="images/img_2.jpg" class="media-1" data-fancybox="gallery">
                            <img src="images/required/BMW-MY23-X7-Secondary-FMA-Desktop.avif" alt="Image"
                                class="img-fluid">
                            <div class="media-1-content">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <a href="images/img_5.jpg" class="media-1" data-fancybox="gallery">
                            <img src="images/required/BMW-Secondary-FMA-Homepage-Cookied-Tile-01-Desktop.avif"
                                alt="Image" class="img-fluid">
                            <div class="media-1-content">
                                <h2>THE 2024 BMW X7</h2>

                                <span class="category">
                                    <h2>NEXT-LEVEL LUXURY</h2>
                                </span>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <a href="images/img_6.jpg" class="media-1" data-fancybox="gallery">
                            <img src="images/required/BMW-Secondary-FMA-Homepage-Tile-04-Desktop.avif" alt="Image"
                                class="img-fluid">
                            <div class="media-1-content">
            ...
            <div class="slide-one-item home-slider owl-carousel">
                <div>
                    <div class="testimonial">
                        ...
                        <blockquote class="mb-5">
                            <p>An ideal race car for ambitious drivers and teams looking to break into the world of
                                motorsport,
                                add more wins, or perfect their craft.
                                The BMW M2 CS Racing boasts impressive performance and technology in a vehicle suitable
                                for all racing formats.</p>
                        </blockquote>
                ...
                <div>
                    <div class="testimonial">
                        ...
                        <blockquote class="mb-5">
                            <p>The BMW M2 CS Racing combines the high-performance engineering of BMW M with the
                                purpose-built
                                expertise of BMW M Motorsport. This popular race car, a favorite with new and
                                experienced drivers,
                    ...
                    <div class="row align-items-stretch">
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-3" data-aos="fade-up">
                            <div class="unit-4 d-flex">
                                <div class="unit-4-icon mr-4"><span class="text-primary"></span><img
                                        src="/images/svgs/arrow-repeat.svg"> </div>
                                <div>
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-3" data-aos="fade-up" data-aos-delay="100">
                            <div class="unit-4 d-flex">
                                <div class="unit-4-icon mr-4"><span class="text-primary"><img
                                            src="/images/svgs/speedometer2.svg"></span></div>
                                <div>

                                    <h3>Check Your Credit Score</h3>
                                    <p>See where you stand on your journey to owning a BMW.
                                    <p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-3" data-aos="fade-up" data-aos-delay="200">
                            <div class="unit-4 d-flex">
                                <div class="unit-4-icon mr-4"><span class="text-primary"></span><img
                                        src="/images/svgs/currency-dollar.svg"></div>
                                <div>
                        ...
                        <div class="col-md-6 col-lg-3 mb-3 mb-lg-3" data-aos="fade-up" data-aos-delay="300">
                            <div class="unit-4 d-flex">
                                <div class="unit-4-icon mr-4"><span class="text-primary"></span><img
                                        src="/images/svgs/envelope.svg"></div>
                                <div>
                        ...
                        <div class="col-md-6 order-md-1" data-jarallax-element="-50">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    <h4>The BMW Group company profile.</h4>
                                    <p class="lead">
                                        The special fascination of the BMW Group not only lies in its products and
                                        technology, but also in the company’s history,
                                        written by inventors, pioneers and brilliant designers. Today, the BMW Group,
                                        with more than 30 production and assembly facilities as well as
                                        a global sales network,
                                        is the world’s leading manufacturer of premium automobiles and motorcycles, and
                                        provider of premium financial and mobility services.</p>
                                </div>
                                <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                                    <div class="unit-4">
                                        <div class="unit-4-icon mr-4 mb-3"><span
                                                class="text-primary icon-phonelink"></span></div>
                                        <div>
                                            <h3>Production today and tomorrow.</h3>
                                            <p>The BMW Group sets trends in production technology and sustainability as
                                                an innovation leader with an intelligent material mix</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                                    <div class="unit-4">
                                        <div class="unit-4-icon mr-4 mb-3"><span
                                                class="text-primary icon-extension"></span></div>
                                        <div>
                                            <h3>Sustainability: the guiding principle for all our actions.</h3>
                                            <p>Long-term thinking and responsible action are the basis of economic
                                                success. </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                            <div class="person text-center bg-white p-4">
                                <img src="images/required/BMW-ceo2.jpg" alt="Image"
                                    class="img-fluid rounded-circle mb-3">
                                <h3>Oliver Zipse</h3>
                                <p class="position text-muted">CEO</p>
                                <p class="mb-4">Year/Place of birth: 1964, Heidelberg (Germany)
                                    Nationality: German<br>Since 16 August 2019: Chairman of the Board of Management of
                                    BMW AG</p>
                        ...
                        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                            <div class="person text-center bg-white p-4">
                                <img src="images/required/BMW-sales.jpg" alt="Image"
                                    class="img-fluid rounded-circle mb-3">
                                <h3>PIETER NOTA</h3>
                                <p class="position text-muted">Customer, Brands, Sales</p>
                                <p class="mb-4">Year/Place of birth: 1964, Wageningen (Netherlands)
                                    Nationality: Dutch<br>Since 1 April 2019: Member of the Board of Management of BMW
                                    AG, Customer, Brands, Sales </p>
                                <ul class="ul-social-circle">
                                    <li><a href="#"><span class="icon-facebook"></span></a></li>
                                    <li><a href="#"><span class="icon-twitter"></span></a></li>
                                    <li><a href="#"><span class="icon-linkedin"></span></a></li>
                        ...
                        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
                            <div class="person text-center bg-white p-4">
                                <img src="images/required/BMW-production.jpg" alt="Image"
                                    class="img-fluid rounded-circle mb-3">
                                <h3>DR. MILAN NEDELJKOVIĆ</h3>
                                <p class="position text-muted">Production</p>
                                <p class="mb-4">Year/Place of birth: 1969, Krusevac (Serbia)
                                    Nationality: Serbian.<br>Since 1 October 2019: Member of the Board of Management of
                                    BMW AG, Production</p>
                                <ul class="ul-social-circle">
                                    <li><a href="#"><span class="icon-facebook"></span></a></li>
                                    <li><a href="#"><span class="icon-twitter"></span></a></li>
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p>If you are unable to find the information you are looking for on the BMW Group
                                        website, please do not hesitate to contact our Customer Service:</p>
                                </div>
